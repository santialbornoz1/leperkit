...
function MyCatalogue({ navigation }) {
    ...
    useEffect(() => {
        ...
        fetch(urlBack + "api/myModules", {
            method: 'POST',
            body: JSON.stringify("ACA VA EL TOKEN"),
            // headers: {
    ...
    return (
        <>
            <Appbar title="Mi catalogo" navigation={navigation} hasBack={true} />
            <View style={styles.container}>
                {isLoading ?
                    ...
                    <>
                        <ScrollView >
                        <Title style={styles.titleDetailScreen}>Estos son tus modulos</Title>
